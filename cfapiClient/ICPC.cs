...
//            using (StreamReader st = new StreamReader(@"C:\Users\kmepv\Documents\icpc.txt"))
//            {
//                string uni;
//                while ((uni = st.ReadLine()) != null)
//                {
//                    rank++;
//                    var team = icpcTeams.Find(i => i.University == uni);

//                    if (team != null)
//                    {
//                        Console.WriteLine($"{team.TeamRating}\t{rank}");
//                    }
//                }
//            }

//            /*
//            Console.WriteLine("<table><thead><tr><th>Rank</th> <th>Country or Region</th> <th>University</th> <th>Member1</th> <th>Member2</th> <th>Member3</th> <th>Team Rating</th></tr> </thead>");
//            foreach(var team in icpcTeams)
//            {
